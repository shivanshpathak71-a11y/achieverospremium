        ...
        <div className="space-y-3">
          ...
          <div className="pt-6 mt-6 border-t border-gray-100">
            ...
            <button
              ...
              className="w-full bg-white border border-gray-200 rounded-2xl p-4 flex items-center gap-3 text-left hover:border-pink-200 hover:shadow-sm transition-all group"
            >
              <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center group-hover:bg-pink-50 transition-colors">
